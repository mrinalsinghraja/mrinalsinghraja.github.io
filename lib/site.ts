...
export const POSITIONING = `Software engineer in ${LOCATION}. I build these for the enjoyment of building them — ${COUNTS.total} live now across the web, macOS and iOS, every one of them free.`;
